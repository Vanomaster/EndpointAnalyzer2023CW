...
/// <inheritdoc />
public class ConfigurationRecommendationsPageQuery : DbQueryBase<PageModel, List<ConfigurationRecommendation>>
{
    ...
    public ConfigurationRecommendationsPageQuery(IDbContextFactory<Context> contextFactory)
        : base(contextFactory)
    {
    }

    /// <inheritdoc/>
    protected override async Task<QueryResult<List<ConfigurationRecommendation>>> ExecuteCoreAsync(PageModel pageModel)
    {
        ...
        var entities = entitiesToFetch
            ...
            .SelectMany(benchmark => benchmark.ConfigurationRecommendations);
        ...
        if (pageModel.SearchPhrase is not null)
        {
            ...
            entities = entities.Where(entity =>
                searchWords.All(word =>
                    (entity.Name + " " + entity.VerificationCommand + " " + entity.VerificationResult).ToLower()
