...
using ConfigurationRecommendationsBenchmark = Dal.Entities.ConfigurationRecommendationsBenchmark;
...
using ScheduleProtoHost = ScheduleService.ProtoHost;
using TrustedHardware = Dal.Entities.TrustedHardware;
using TrustedHardwareBenchmark = Dal.Entities.TrustedHardwareBenchmark;
using TrustedSoftware = Dal.Entities.TrustedSoftware;
using TrustedSoftwareBenchmark = Dal.Entities.TrustedSoftwareBenchmark;
...
public static class Mapper
{
    public static ProtoBenchmark? MapToProtoBenchmark(this BenchmarkModel? model)
    {
        ...
        var resultModel = new ProtoBenchmark
        {
            ...
            PcQuantity = model.ComputerQuantity,
        };
    ...
    public static BenchmarkModel? MapToBenchmark(this ProtoBenchmark? model)
    {
        ...
        var resultModel = new BenchmarkModel
        {
            ...
            Name = model.Name,
            Description = model.Description,
            ComputerQuantity = model.PcQuantity,
        };

        return resultModel;
    }

    // public static ProtoBenchmark? MapToProtoBenchmark(this BenchmarkEntity? model)
    // {
    //     if (model == null)
    //     {
    //         return null;
    ...
    // }
    //
    // public static BenchmarkEntity? MapToBenchmark(this ProtoBenchmark? model)
    // {
    //     if (model == null)
    //     {
    //         return null;
    ...
    public static PageModel? MapToPageModel(this ProtoPageModel? model)
    {
        if (model == null)
        {
            return null;
    ...
    public static AnalysisModel? MapToAnalysisModel(this ProtoAnalysisModel? model)
    {
        if (model == null)
        {
            return null;
        ...
        var resultModel = new AnalysisModel
        {
            PcIp = model.PcIp,
    ...
    public static NetworkProtoHost? MapToProtoHost(this Host? model)
    {
        if (model == null)
        {
            return null;
        ...
        var resultModel = new NetworkProtoHost
        {
            Ip = model.Ip,
            Name = model.Name,
        };
    ...
    public static IEnumerable<ProtoConfigurationRecommendation> MapToProtoConfigurationRecommendations(
        this IEnumerable<ConfigurationRecommendation> model)
    {
        ...
        this ProtoConfigurationRecommendationsBenchmark? model)
    {
        ...
        {
            resultModel.Benchmarks.Add(new Dal.Entities.Benchmark
            {
                Id = model.ParentId.ToGuid(),
            });
        }

        // var recommendations = MapToRecommendations(model.ConfigurationRecommendations);
        // resultModel.ConfigurationRecommendations.AddRange(recommendations);

        return resultModel;
    }

    public static IEnumerable<ConfigurationRecommendation> MapToRecommendations(this IEnumerable<ProtoConfigurationRecommendation> model)
    {
        return model.Select(recommendation =>
        {
            var configurationRecommendation = new ConfigurationRecommendation
            {
                Id = recommendation.Id.ToGuid(),
                Name = recommendation.Name,
                VerificationCommand = recommendation.VerificationCommand,
                VerificationResult = recommendation.VerificationResult,
                Configuration = new Dal.Entities.Configuration
                {
            ...
            if (recommendation.ParentId != null)
            {
                configurationRecommendation.ConfigurationRecommendationsBenchmarks.Add(new Dal.Entities.ConfigurationRecommendationsBenchmark
                {
                    Id = recommendation.ParentId.ToGuid(),
                });
            }
    ...
    public static TrustedSoftwareBenchmark? MapToTrustedSoftwareBenchmark(this ProtoTrustedSoftwareBenchmark? model)
    {
        ...
        // var software = MapToTrustedSoftware(model.TrustedSoftware);
        // resultModel.TrustedSoftware.AddRange(software);
    ...
    public static IEnumerable<TrustedSoftware> MapToTrustedSoftware(this IEnumerable<ProtoTrustedSoftware> model)
    {
        return model.Select(software =>
        {
            var trustedSoftware = new TrustedSoftware
            {
                Id = software.Id.ToGuid(),
                Name = software.Name,
                Version = software.Version,
            };
            if (software.ParentId != null)
            {
                trustedSoftware.TrustedSoftwareBenchmarks.Add(new Dal.Entities.TrustedSoftwareBenchmark
                {
                    Id = software.ParentId.ToGuid(),
                });
            }

            return trustedSoftware;
        });
    }
    ...
    public static TrustedHardwareBenchmark? MapToTrustedHardwareBenchmark(this ProtoTrustedHardwareBenchmark? model)
    {
        ...
        // var hardware = MapToTrustedHardware(model.TrustedHardware);
        // resultModel.TrustedHardware.AddRange(hardware);
    ...
    public static IEnumerable<TrustedHardware> MapToTrustedHardware(this IEnumerable<ProtoTrustedHardware> model)
    {
        return model.Select(hardware =>
        {
            var trustedHardware = new TrustedHardware
            {
                Id = hardware.Id.ToGuid(),
                Name = hardware.Name,
                HardwareId = hardware.HardwareId,
            };
            if (hardware.ParentId != null)
            {
                trustedHardware.TrustedHardwareBenchmarks.Add(new Dal.Entities.TrustedHardwareBenchmark
                {
                    Id = hardware.ParentId.ToGuid(),
                });
            }

            return trustedHardware;
        });
    }
}