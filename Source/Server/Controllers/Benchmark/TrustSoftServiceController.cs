...
/// <inheritdoc />
public class TrustSoftServiceController : TrustedSoftwareBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConfigurationRecommendationsServiceController"/> class.
    /// </summary>
    /// <param name="service">Service.</param>
    public TrustSoftServiceController(TrustSoftService service)
    {
        Service = service;
    }

    private TrustSoftService Service { get; }
    ...
    private async Task<GetResponse> GetAsync(GetRequest model)
    {
        ...
        var data = new TrustedSoftwareData();
        var protoModels = queryResult.Data.MapToProtoTrustedSoftware();
    ...
    {
        var recommendations = model.Hardware.MapToTrustedSoftware().ToList();
