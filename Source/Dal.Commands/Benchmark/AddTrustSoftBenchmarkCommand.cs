...
/// <inheritdoc />
public class AddTrustSoftBenchmarkCommand : DbCommandBase<TrustedSoftwareBenchmark>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AddConfigurationRecommendationsBenchmarkCommand"/> class.
    /// </summary>
    /// <param name="contextFactory">Context factory.</param>
    public AddTrustSoftBenchmarkCommand(IDbContextFactory<Context> contextFactory)
        : base(contextFactory)
    {
    }

    /// <inheritdoc/>
    protected override async Task<CommandResult> ExecuteCoreAsync(TrustedSoftwareBenchmark entityToAdd)
    {
        ...
        parent.TrustedSoftwareBenchmark = entityToAdd;
