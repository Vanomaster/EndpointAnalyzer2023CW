...
using Benchmark = Dal.Entities.ConfigurationRecommendationsBenchmark;

namespace Server.Services;

public class ConfigurationRecommendationsBenchmarkService : IDbService<Benchmark>
{
    ...
    public ConfigurationRecommendationsBenchmarkService(IServiceProvider serviceProvider)
    {
    ...
    public async Task<QueryResult<List<Benchmark>>> GetPageAsync(PageModel pageModel)
    {
    ...
    public async Task<QueryResult<Benchmark>> GetOneAsync(string benchmarkName)
    {
        ...
        var benchmarkQuery = scope.ServiceProvider.GetRequiredService<ConfigurationRecommendationsBenchmarkQuery>();
    ...
    public async Task<CommandResult> AddAsync(Benchmark model)
    {
        ...
        using var scope = ServiceProvider.CreateScope();
        var addCommand = scope.ServiceProvider.GetRequiredService<AddConfigurationRecommendationsBenchmarkCommand>();
