...
using Benchmark = Dal.Entities.TrustedSoftwareBenchmark;

namespace Server.Services;

public class TrustSoftBenchmarkService
{
    ...
    public TrustSoftBenchmarkService(IServiceProvider serviceProvider)
    {
    ...
    public async Task<QueryResult<Benchmark>> GetOneAsync(string benchmarkName)
    {
        ...
        var benchmarkQuery = scope.ServiceProvider.GetRequiredService<TrusSoftBenchmarkQuery>();
    ...
    public async Task<CommandResult> AddAsync(Benchmark model)
    {
        ...
        using var scope = ServiceProvider.CreateScope();
        var addCommand = scope.ServiceProvider.GetRequiredService<AddTrustSoftBenchmarkCommand>();
